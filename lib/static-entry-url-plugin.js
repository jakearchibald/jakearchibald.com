...
const importPrefix = 'static-entry-url:';

export default function staticEntryURLPlugin() {
  return {
    name: 'static-entry-url',
    ...
    load(id) {
      ...
      return `export default import.meta.ROLLUP_FILE_URL_${this.emitFile({
        type: 'chunk',
        id: realId,
        fileName: 'static/' + path.basename(realId.replace(/.tsx?$/, '.js')),
      })};`;
    },
  };
}
