...
const srcPlaceholder = 'CLIENT_BUNDLE_SRC';
  ...
  return {
    ...
    load(id) {
      ...
      return [
        ...
        `export const src = import.meta.${srcPlaceholder + exportCounter}`,
      ].join('\n');
    },
    ...
    resolveImportMeta(property, { moduleId, format }) {
      ...
      } else if (property.startsWith(srcPlaceholder)) {
        num = Number(property.slice(srcPlaceholder.length));
      } else {
      ...
      if (property.startsWith(srcPlaceholder)) {
