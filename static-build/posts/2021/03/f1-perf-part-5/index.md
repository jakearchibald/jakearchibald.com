...
Pretty good! This team was called Racing Point last year (and 2019), and their site was a bit of a performance disaster, but it looks like that's all fixed!

## Possible improvements

- **2 second delay to content render** caused by font foundry CSS. Covered in detail below.
- **1.25 second delay to content render** caused by additional CSS on another server. This problem is [covered in part 1](/2021/f1-perf-part-1/#avoid-blocking-resources-on-other-servers), but the solution here is just to move the CSS to the same server as the page.

Remember these delays overlap in some cases.

Praise use of preloads & preconnect

Praise nomodule polyfills
