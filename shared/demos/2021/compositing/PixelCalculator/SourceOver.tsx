...
import { Pixel, multiplyAlpha, unmultiplyAlpha } from './utils';
...
export default class SourceOver extends Component<Props, State> {
  state: State = {
    ...
    return (
      <div class="full-figure max-figure pixel-calculator-figure">
        <div class="pixel-calculator">
          ...
          <Results
            label="Transformed destination"
            pixel={transformedDestination}
          />
